...
$username = "florida_app";
$password = "Florida@chopra4321";
$dbname = "florida_solar";

if( $_SERVER['SERVER_ADDR'] == '127.0.0.1' && $_SERVER['REMOTE_ADDR'] == '127.0.0.1' )
{
$servername = "localhost";
$username = "orient_electric";
$password = "Yhokk(@mkno1410";
$dbname = "orient_electric";
}

$project_name = "Florida Electric Street Light RMS";
