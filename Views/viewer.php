...
?>
  ...
  <body class="w3-light-grey">
    ...
    <!-- Top container -->
    <div class="w3-bar w3-top w3-large w3-card-4" style="z-index:4;background-color:#cccc;color:#cccc;">
      ...
      <span class="w3-bar-item w3-hide-small" style="background-color:#fe0000;height:61px;padding-top:15px;"><b><?php echo $project_name; ?></b></span>
      <span class="w3-bar-item w3-hide-medium w3-hide-large" style="background-color:#fe0000;height:61px;padding-top:15px;"><b>FloridaRMS</b></span>
