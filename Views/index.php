...
if(str_contains($_SERVER['HTTP_HOST'],'www')){
	header('Location: https://www.floridaindustries.in');
}
session_start();
...
<div class="w3-bar w3-top w3-large w3-card-4" style="z-index:4;background-color:#cccc;color:#fff;">
  <img src="../img/header_logo2.jpg" class="w3-bar-item w3-hide-small" style="height: 61px;">
  <span class="w3-bar-item w3-hide-small" style="background-color:#333;height:61px;padding-top:13px;"><b><?php echo $project_name; ?></b></span>
  <span class="w3-bar-item w3-hide-medium w3-hide-large" style="background-color:#fe0000;height:61px;padding-top:13px;"><b>FloridaRMS</b></span>
  <!-- <img src="../img/line.png" style="height:61px;"> -->
  <span class="w3-bar-item0 w3-right w3-hide-small w3-hide"><img src="../img/header_logo2.jpg" style="height:61px;"></span>
  <span class="w3-hide-small w3-right w3-xlarge w3-margin-right" style="margin-top:10px;color:#fe0000;">मुख्यमंत्री ग्रामीण सोलर स्ट्रीट लाइट योजना</span>
</div>

<div class="w3-display-container" style="height:600px;margin-top:50px;">
    <div class="w3-display-right w3-padding">
		<div class="w3-panel w3-card-4 w3-round-large w3-center margin-rt50" style="background-color:#cccc;color:#fe0000;">
			<img src="../img/header_logo2.jpg" alt="Avatar" style="min-width:100px;width:15%;" class="w3-margin-top">
			<form class="" action="../Controller/login.php" method="POST">
				<div class="w3-section">
					...
					<button class="w3-btn w3-border w3-round-large w3-margin-top w3-center w3-text-white" style="width:300px;background-color:#fe0000;" type="submit">Login</button>
				</div>
			</form>
