...
.w3-color, .w3-hover-color:hover{color: #fff!important;background-color: #333!important;}
.w3-text-color, .w3-hover-text-color:hover {color: #fe0000!important;}
...
<div class="w3-bar w3-top w3-large w3-card-4" style="z-index:4;background-color:#cccc;color:#fff;">
  ...
  <span class="w3-bar-item w3-hide-small" style="background-color:#333;height:61px;padding-top:15px;"><b><?php echo $project_name; ?></b></span>
  <span class="w3-bar-item w3-hide-medium w3-hide-large" style="background-color:#cccc;height:61px;padding-top:15px;"><b>FloridaRMS</b></span>
  ...
  <span class="w3-hide-small w3-right w3-large w3-margin-left w3-margin-right" style="margin-top:17px;color:#fe0000;"><span>Welcome, <strong><?php echo $name; ?></strong></span></span>
...
<div class="w3-main" style="margin-left:200px;margin-top:43px;">
  ...
  <footer class="w3-container w3-padding-16 w3-light-grey">
    ...
    <p class="w3-right w3-margin-right">Powered by <a href="https://www.floridaindustries.in" target="_blank">Florida Electric</a></p>
  </footer>
</div>
